"""
1) Admin filterek
    a) Alakítsd át a kiadás éve admin filtert: használj saját kategóriákat, vagy rangefiltert!
...
4) Kölcsönzés:
    ...
    b) Minden könyv admin oldalán jelenjen meg egy gomb, ami "kikölcsönzi" a könyvet!
    c) A könyv adatait tartalmazó oldalon (details view) szintén legyen egy kölcsönzés gomb!
"""